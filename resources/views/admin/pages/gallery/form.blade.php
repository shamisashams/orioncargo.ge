...
{{-- page title --}}
@section('title', $gallery->category_id ? __('admin.gallery-update') : 'admin.gallery-create')
                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            {!! Form::submit($gallery->created_at ? __('admin.update') : __('admin.create'),['class' => 'btn cyan waves-effect waves-light ']) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
